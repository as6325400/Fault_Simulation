...
class LevelizedBaselineSimulator : public FaultSimulator {
public:
    LevelizedBaselineSimulator(const core::Circuit& circuit,
                               const std::vector<io::PatternRow>& rows);
    ~LevelizedBaselineSimulator() override = default;
